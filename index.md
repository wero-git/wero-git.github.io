...
<style>
  ...
  background-image: linear-gradient(to bottom, rgba(15, 23, 42, 0.85), rgba(15, 23, 42, 0.95)), url('https://github.com/wero-git/Winston_Engamba/blob/main/images/tech_dna_process_fusion.png') !important;
